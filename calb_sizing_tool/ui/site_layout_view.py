...
def show():
    ...
    # If DC run exists but count is 0, show 0 instead of TBD
    if bool(stage13_output) and dc_blocks_total == 0:
        pass 
    ...
    c_status4.metric("DC Blocks (total)", dc_blocks_total if dc_blocks_total is not None else "TBD")
